...
// Change this line in script.js to expose it globally to ar-core.js
window.pointer = { x: 0, y: 0, rotateX: 25, rotateY: 35, rx: 0, ry: 0 };
const pointer = window.pointer; // Keeps compatibility with the rest of script.js
